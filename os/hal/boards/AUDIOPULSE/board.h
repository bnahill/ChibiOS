...
#define VAL_GPIOC_AFRL              (PIN_AFIO_AF(GPIOC_CODEC_LRCK, 8U) |     \
                                     PIN_AFIO_AF(GPIOC_CODEC_SDO, 6U) |     \
...
#define VAL_GPIOC_AFRH              (PIN_AFIO_AF(GPIOC_LED3, 12U) |        \
                                     PIN_AFIO_AF(GPIOC_CODEC_MCLK, 5U) |        \
                                     PIN_AFIO_AF(GPIOC_SPI_SCK, 6U) |        \
